    ...
    with open(filename, "w") as csvfile:
        ...
        for j, goal in enumerate(tasks):
            ...
            policy2 = BaseEmpathic(alpha=1.0, gamma=1.0, epsilon=0.4,
                                       default_q=DEFAULT_Q, num_actions=5, rng=rng1, others_policy=humans_policy, others_init=[[1,3]], others_dist=[0.25, 0.75], penalty=-2*EPISODE_LENGTH, others_alpha=[4.01, 4.01], objects=OBJECTS2, problem_mode=problem_mode)
            ...
            policy3 = BaseEmpathic(alpha=1.0, gamma=1.0, epsilon=0.4,
                                       default_q=DEFAULT_Q, num_actions=5, rng=rng3, others_policy=humans_policy, others_init=[[1,3]], others_dist=[0.25, 0.75], penalty=-2*EPISODE_LENGTH, others_alpha=[4.01, 4.01], objects=OBJECTS2, problem_mode=problem_mode, full_observability=True)
